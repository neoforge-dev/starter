...
class PasswordValidator:
    ...
    def generate_password_strength_score(self, password: str) -> Tuple[int, str]:
        ...
        has_no_common_words = not any(
            word in password.lower() for word in ["password", "admin", "user"]
        )
...
def validate_password_strength(password: str) -> Tuple[bool, List[str], int, str]:
    ...
    # Get strength score
    strength_score, strength_level = validator.generate_password_strength_score(
        password
    )
