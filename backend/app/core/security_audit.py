...
class SecurityAuditor:
    ...
    async def log_security_event(
        ...
        await self._store_redis_event(event_type, severity, user_id, ip_address, details)
        
        # Check for security patterns that require immediate attention
        await self._check_security_patterns(db, event_type, user_id, ip_address, severity)
    ...
    async def _check_security_patterns(
        ...
        try:
            ...
            if event_type in [SecurityEventType.LOGIN_FAILED, SecurityEventType.LOGIN_SUCCESS]:
            ...
            logger.error("security_pattern_check_failed", error=str(e), event_type=event_type.value)
