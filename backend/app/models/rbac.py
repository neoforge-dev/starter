...
from sqlalchemy import String, Text, Boolean, ForeignKey, Index, Table, Column, UniqueConstraint, DateTime
...
user_role_assignments = Table(
    ...
    Column("organization_id", ForeignKey("organizations.id", ondelete="CASCADE"), nullable=True),
    Column("assigned_at", DateTime, default=datetime.utcnow, nullable=False),
    Column("assigned_by_id", ForeignKey("users.id", ondelete="SET NULL"), nullable=True),
...
class Permission(Base):
    ...
    description: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        doc="Detailed description of what this permission allows"
    )
    ...
    action: Mapped[PermissionAction] = mapped_column(
        nullable=False,
        index=True,
        doc="Action this permission allows"
    )
...
class Role(Base):
    ...
    description: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        doc="Role description and purpose"
    )
    ...
    is_system: Mapped[bool] = mapped_column(
        ...
        default=False,
        nullable=False,
        doc="System role (cannot be deleted)"
    )
    is_active: Mapped[bool] = mapped_column(
        Boolean,
        default=True,
    ...
    settings: Mapped[Optional[dict]] = mapped_column(
        JSONB,
        nullable=True,
        doc="Role-specific settings and configuration"
    )
    ...
    __table_args__ = (
        ...
        UniqueConstraint("name", "tenant_id", "organization_id", name="uq_role_name_context"),
    ...
    def __repr__(self) -> str:
        return f"Role(name='{self.name}', type='{self.type}', tenant_id={self.tenant_id})"
...
class ResourcePermission(Base):
    ...
    resource_id: Mapped[str] = mapped_column(
        ...
        nullable=False,
        index=True,
        doc="Specific resource identifier"
    )
    ...
    expires_at: Mapped[Optional[datetime]] = mapped_column(
        nullable=True,
        doc="Permission expiration date (NULL for permanent)"
    )
    ...
    conditions: Mapped[Optional[dict]] = mapped_column(
        JSONB,
        nullable=True,
        doc="Additional conditions for this permission grant"
    )
    notes: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        doc="Administrative notes about this permission grant"
    )
...
class PermissionCache(Base):
    ...
    roles: Mapped[List[str]] = mapped_column(
        JSONB,
        nullable=False,
        doc="List of role names the user has in this context"
    )
    ...
    last_computed_at: Mapped[datetime] = mapped_column(
        nullable=False,
        doc="When permissions were last computed"
    )
