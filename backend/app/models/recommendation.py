...
class Recommendation(Base):
    ...
    title: Mapped[str] = mapped_column(
        String(200),
        nullable=False,
        comment="Recommendation title/headline"
    )
    ...
    rec_metadata: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        comment="Metadata about how recommendation was generated"
    )
    ...
    impressions: Mapped[int] = mapped_column(
        Integer,
        default=0,
        comment="Number of times recommendation was shown"
    )
    clicks: Mapped[int] = mapped_column(
        Integer,
        default=0,
        comment="Number of clicks on recommendation"
    )
    ...
    shown_at: Mapped[Optional[datetime]] = mapped_column(
        nullable=True,
        comment="When recommendation was first shown to user"
    )
    clicked_at: Mapped[Optional[datetime]] = mapped_column(
        nullable=True,
        comment="When user clicked on recommendation"
    )
    dismissed_at: Mapped[Optional[datetime]] = mapped_column(
        nullable=True,
        comment="When user dismissed recommendation"
    )
    ...
    __table_args__ = (
        ...
        Index('idx_recommendations_priority_confidence', 'priority_score', 'confidence_score'),
        ...
        UniqueConstraint('user_id', 'type', 'recommendation_id', name='uq_user_type_recommendation'),
        
        # JSONB indexing for context and metadata (PostgreSQL specific)
        Index('idx_recommendations_context_gin', 'context', postgresql_using='gin'),
        Index('idx_recommendations_metadata_gin', 'rec_metadata', postgresql_using='gin'),
    )
...
class UserPreferences(Base):
    ...
    feature_interests: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        comment="Interest scores for different features (0.0-1.0)"
    )
    content_preferences: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        comment="Content type preferences and engagement patterns"
    )
    ui_preferences: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        comment="UI/UX preferences and customizations"
    )
    behavioral_patterns: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        comment="Behavioral patterns and usage analytics"
    )
    ...
    weekly_active_days: Mapped[int] = mapped_column(
        Integer,
        default=0,
        comment="Number of active days per week"
    )
    feature_adoption_rate: Mapped[float] = mapped_column(
        Float,
        default=0.0,
        comment="Rate of adopting new features (0.0-1.0)"
    )
    ...
    notification_preferences: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        comment="How user wants to receive recommendations"
    )
    max_daily_recommendations: Mapped[int] = mapped_column(
        Integer,
        default=5,
        comment="Maximum recommendations per day"
    )
    ...
    last_analyzed_at: Mapped[Optional[datetime]] = mapped_column(
        nullable=True,
        comment="When preferences were last analyzed from event data"
    )
    ...
    __table_args__ = (
        ...
        Index('idx_user_preferences_features_gin', 'feature_interests', postgresql_using='gin'),
        Index('idx_user_preferences_content_gin', 'content_preferences', postgresql_using='gin'),
        Index('idx_user_preferences_behavior_gin', 'behavioral_patterns', postgresql_using='gin'),
    )
...
class RecommendationFeedback(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_recommendation_feedback_type_action', 'feedback_type', 'action_taken'),
        ...
        UniqueConstraint('recommendation_id', 'user_id', name='uq_recommendation_user_feedback'),
        
        # JSONB indexing for context
        Index('idx_recommendation_feedback_context_gin', 'context', postgresql_using='gin'),
    )
...
class SimilarUsers(Base):
    ...
    similarity_score: Mapped[float] = mapped_column(
        ...
        nullable=False,
        index=True,
        comment="Similarity score (0.0-1.0)"
    )
    algorithm: Mapped[str] = mapped_column(
        String(50),
        nullable=False,
        comment="Algorithm used to compute similarity"
    )
    ...
    behavioral_similarity: Mapped[Optional[float]] = mapped_column(
        Float,
        nullable=True,
        comment="Behavioral pattern similarity score"
    )
    preference_similarity: Mapped[Optional[float]] = mapped_column(
        Float,
        nullable=True,
        comment="Preference similarity score"
    )
    demographic_similarity: Mapped[Optional[float]] = mapped_column(
        Float,
        nullable=True,
        comment="Demographic similarity score (if available)"
    )
    ...
    common_features: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        comment="Features both users have used"
    )
    ...
    expires_at: Mapped[datetime] = mapped_column(
        nullable=False,
        comment="When similarity computation expires"
    )
    ...
    __table_args__ = (
        ...
        # JSONB indexing for common features
        Index('idx_similar_users_features_gin', 'common_features', postgresql_using='gin'),
    )