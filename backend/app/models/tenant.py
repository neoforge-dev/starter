...
class Tenant(Base):
    ...
    name: Mapped[str] = mapped_column(
        String(200), 
        nullable=False,
        doc="Display name for the tenant"
    )
    ...
    settings: Mapped[Optional[dict]] = mapped_column(
        JSONB,
        nullable=True,
        doc="Tenant-specific configuration and feature flags"
    )
    limits: Mapped[Optional[dict]] = mapped_column(
        JSONB,
        nullable=True,
        doc="Resource limits (users, storage, API calls, etc.)"
    )
    branding: Mapped[Optional[dict]] = mapped_column(
        JSONB,
        nullable=True,
        doc="Custom branding (logo, colors, theme)"
    )
    ...
    billing_email: Mapped[Optional[str]] = mapped_column(
        String(255),
        nullable=True,
        doc="Primary billing contact email"
    )
    
    # Lifecycle management
    trial_ends_at: Mapped[Optional[datetime]] = mapped_column(
        nullable=True,
        doc="Trial expiration date"
    )
    suspended_at: Mapped[Optional[datetime]] = mapped_column(
        nullable=True,
        doc="When tenant was suspended"
    )
    suspension_reason: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        doc="Reason for suspension"
    )
    ...
    allowed_ip_ranges: Mapped[Optional[List[str]]] = mapped_column(
        JSONB,
        nullable=True,
        doc="Allowed IP ranges for tenant access"
    )
...
class Organization(Base):
    ...
    description: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        doc="Organization description and purpose"
    )
    ...
    settings: Mapped[Optional[dict]] = mapped_column(
        JSONB,
        nullable=True,
        doc="Organization-specific settings and preferences"
    )
...
class OrganizationMembership(Base):
    ...
    joined_at: Mapped[Optional[datetime]] = mapped_column(
        nullable=True,
        doc="When membership was activated"
    )
    ...
    invitation_expires_at: Mapped[Optional[datetime]] = mapped_column(
        nullable=True,
        doc="Invitation expiration date"
    )
    ...
    permissions_override: Mapped[Optional[dict]] = mapped_column(
        JSONB,
        nullable=True,
        doc="Member-specific permission overrides"
    )
    notes: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        doc="Administrative notes about membership"
    )
