...
from app.crud import ab_test, event as event_crud
...
from app.schemas.ab_test import (
    ...
    AbTestAnalyticsQuery, AbTestAnalyticsResponse, AbTestStatisticalReport,
    AbTestStatus, AbTestVariantUpdate, AbTestVariantResponse
)
...
async def list_ab_tests(
    *,
    ...
    status_filter: Optional[List[AbTestStatus]] = Query(None, description="Filter by test status"),
    ...
    *,
    ...
    if existing_test:
        raise HTTPException(
            ...
            detail="Test key already exists"
        )
...
def _is_valid_status_transition(current_status: str, new_status: str) -> bool:
    ...
    valid_transitions = {
        ...
        AbTestStatus.PAUSED: [AbTestStatus.ACTIVE, AbTestStatus.COMPLETED, AbTestStatus.ARCHIVED],
