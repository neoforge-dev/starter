...
@router.get("/projects", response_model=Union[PaginatedResponse, CursorPaginatedResponse])
async def list_projects(
    ...
    sort_by: str = Query("created_at", description="Field to sort by (created_at, updated_at, name)"),
    ...
    name_like: Optional[str] = Query(None, description="Search projects by name (partial match)"),
    ...
    **Filtering:**
    ...
    if use_offset_pagination:
        ...
        project_data = [ProjectRead.model_validate(project) for project in paginated_result.data]
