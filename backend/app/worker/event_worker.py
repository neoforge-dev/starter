...
class EventProcessor:
            ...
            for _ in range(self.batch_size):
                ...
                if result:
                    ...
                    try:
                        ...
                        logger.warning(
                            "event_worker_invalid_json", error=str(e), data=event_data
                        )
                else:
    ...
    async def _process_event_batch(self, events: List[Dict[str, Any]]):
        ...
        for event_type, type_events in events_by_type.items():
            try:
                ...
                logger.error(
                    "event_worker_type_processing_error",
    ...
    async def _update_realtime_counters(
        self, event_type: str, events: List[Dict[str, Any]], hour_key: str, day_key: str
    ):
    ...
    async def _process_performance_events(
        self, events: List[Dict[str, Any]], hour_key: str
    ):
        ...
        for event in events:
            ...
            if "status_code" in properties and str(
    ...
    async def _process_interaction_events(
        self, events: List[Dict[str, Any]], hour_key: str
    ):
