...
class TestEmailTasks:
    ...
    @pytest.mark.asyncio
    async def test_send_welcome_email_async_success(self, mock_send_email, mock_async_session):
        ...
        assert call_args.kwargs["email_id"].startswith("welcome_test@example.com_test_tok")
    ...
    @pytest.mark.asyncio
    async def test_send_verification_email_async_success(self, mock_send_email, mock_async_session):
    ...
    @pytest.mark.asyncio
    async def test_send_password_reset_email_async_success(self, mock_send_email, mock_async_session):
    ...
    def test_welcome_email_task_success(self):
        ...
        with patch('app.worker.email_worker.asyncio.run') as mock_run:
            mock_run.return_value = {"status": "success", "email": "test@example.com", "type": "welcome"}
    ...
    def test_password_reset_email_task_success(self):
        ...
        with patch('app.worker.email_worker.asyncio.run') as mock_run:
            mock_run.return_value = {"status": "success", "email": "test@example.com", "type": "password_reset"}
    ...
    def test_verification_email_task_success(self):
        ...
        with patch('app.worker.email_worker.asyncio.run') as mock_run:
            mock_run.return_value = {"status": "success", "email": "test@example.com", "type": "verification"}
