...
class TestPersonalizationProfiles:
    ...
    async def test_create_or_update_profile(
        self,
        client: TestClient,
        db: AsyncSession,
        normal_user_token_headers: Dict[str, str],
        ...
        profile_data = {
            ...
            "ui_preferences": {"theme": "dark", "compact_layout": True},
            "content_preferences": {"preferred_types": ["technical", "advanced"]},
        }
    ...
    async def test_recompute_profile(
        self,
        client: TestClient,
        db: AsyncSession,
        normal_user_token_headers: Dict[str, str],
...
class TestPersonalizationConfig:
    ...
    async def test_get_personalized_config(
        self,
        client: TestClient,
        db: AsyncSession,
        normal_user_token_headers: Dict[str, str],
    ...
    async def test_get_config_with_caching(
        self,
        client: TestClient,
        db: AsyncSession,
        normal_user_token_headers: Dict[str, str],
...
class TestPersonalizationRules:
    ...
    async def test_list_rules_with_filters(
        ...
        rule1 = await create_random_personalization_rule(
            db, personalization_type="ui_adaptation"
        )
        rule2 = await create_random_personalization_rule(
            db, personalization_type="content_filter"
        )
...
class TestPersonalizationInteractions:
    ...
    async def test_track_bulk_interactions(
        self,
        client: TestClient,
        db: AsyncSession,
        normal_user_token_headers: Dict[str, str],
    ...
    async def test_get_user_interactions(
        ...
        interaction1 = await create_random_personalization_interaction(
            db, user_id=user.id, rule_id=rule.rule_id
        )
        interaction2 = await create_random_personalization_interaction(
            db, user_id=user.id, rule_id=rule.rule_id
        )
    ...
    async def test_get_interactions_with_filters(
        ...
        await create_random_personalization_interaction(
            db, user_id=user.id, rule_id=rule.rule_id, context="dashboard"
        )
        await create_random_personalization_interaction(
            db, user_id=user.id, rule_id=rule.rule_id, context="settings"
        )
...
class TestPersonalizationAnalytics:
    ...
    async def test_get_segment_analytics(
        self,
        client: TestClient,
        db: AsyncSession,
        superuser_token_headers: Dict[str, str],
        ...
        user1 = await create_random_user(db)
        user2 = await create_random_user(db)
        profile1 = await create_random_personalization_profile(
            db, user_id=user1.id, segment="new_user"
        )
        profile2 = await create_random_personalization_profile(
            db, user_id=user2.id, segment="power_user"
        )
...
class TestPersonalizationSecurity:
    ...
    async def test_admin_access_required_for_rules(
        self, client: TestClient, normal_user_token_headers: Dict[str, str]
    ):
    ...
    async def test_admin_access_required_for_analytics(
        self, client: TestClient, normal_user_token_headers: Dict[str, str]
    ):
...
class TestPersonalizationPerformance:
    ...
    async def test_config_generation_performance(
        self,
        client: TestClient,
        db: AsyncSession,
        normal_user_token_headers: Dict[str, str],
        ...
        request_data = {"user_id": user.id, "context": "dashboard", "max_rules": 50}
    ...
    async def test_bulk_interaction_tracking_performance(
        self,
        client: TestClient,
        db: AsyncSession,
        normal_user_token_headers: Dict[str, str],
...
class TestPersonalizationIntegration:
    ...
    async def test_integration_with_ab_testing(
        self,
        client: TestClient,
        db: AsyncSession,
        superuser_token_headers: Dict[str, str],
    ...
    async def test_integration_with_event_tracking(
        self,
        client: TestClient,
        db: AsyncSession,
        normal_user_token_headers: Dict[str, str],
        ...
        tracked_interaction = next(
            (i for i in interactions if i["interaction_type"] == "feature_used"), None
        )

        assert tracked_interaction is not None
        assert (
            tracked_interaction["personalization_data"]["feature_name"]
            == "advanced_analytics"
        )
