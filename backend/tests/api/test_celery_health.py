...
class TestCeleryHealthChecks:
    ...
    def test_health_check_with_no_celery_workers(self, client):
        ...
        with patch("app.main.celery_app.control.inspect") as mock_inspect:
            ...
            with patch("app.main.get_db") as mock_get_db, patch(
                ...
                )  # Overall status is unhealthy due to no workers
    ...
    def test_health_check_response_model_structure(self, client):
        ...
        with patch("app.main.celery_app.control.inspect") as mock_inspect, patch(
            "app.main.get_db"
        ) as mock_get_db, patch("app.main.get_redis") as mock_get_redis:
