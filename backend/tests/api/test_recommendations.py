...
from app.models.recommendation import Recommendation, UserPreferences, RecommendationFeedback
from app.models.user import User
from app.schemas.recommendation import (
    RecommendationCreate, RecommendationFeedbackCreate, UserPreferencesUpdate,
...
class TestRecommendationEndpoints:
    ...
    @pytest.fixture
    async def sample_user_preferences(self, db: AsyncSession, normal_user: User) -> UserPreferences:
    ...
    async def test_get_user_recommendations(
        ...
        assert recommendations[0]["confidence_score"] >= recommendations[1]["confidence_score"]  # Sorted by score
    ...
    async def test_get_trending_recommendations(
        ...
        await crud_recommendation.recommendation.update_engagement(
            db, recommendation_id=rec.recommendation_id, action="shown", increment_impressions=True
        )
        await crud_recommendation.recommendation.update_engagement(
            db, recommendation_id=rec.recommendation_id, action="clicked", increment_clicks=True
        )
...
class TestRecommendationCRUDOperations:
    ...
    async def test_recommendation_crud_basic_operations(self, db: AsyncSession, normal_user: User):
        ...
        created_rec = await crud_recommendation.recommendation.create(db, obj_in=rec_create)
    ...
    async def test_user_preferences_crud_operations(self, db: AsyncSession, normal_user: User):
    ...
    async def test_recommendation_feedback_crud(self, db: AsyncSession, normal_user: User):
        ...
        recommendation = await crud_recommendation.recommendation.create(db, obj_in=rec_create)
    ...
    async def test_bulk_recommendation_creation(self, db: AsyncSession, normal_user: User):
        ...
        recommendations = await crud_recommendation.recommendation.create_bulk(db, obj_in=bulk_data)
    ...
    async def test_recommendation_performance_analytics(self, db: AsyncSession, normal_user: User):
    ...
    async def test_expired_recommendation_cleanup(self, db: AsyncSession, normal_user: User):
        ...
        expired_rec = await crud_recommendation.recommendation.create(db, obj_in=expired_rec_create)
        ...
        updated_rec = await crud_recommendation.recommendation.get(db, id=expired_rec.id)
