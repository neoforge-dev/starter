...
async def test_create_admin_permission_denied(
    client: AsyncClient,
    db: AsyncSession,
    readonly_admin_headers: dict,
    test_settings: Settings,
) -> None:
...
async def test_read_admin_me(
    ...
    response = await client.get(
        f"{test_settings.api_v1_str}/admin/me", headers=admin_headers
    )
...
async def test_read_admin(
    ...
    response = await client.get(
        f"{test_settings.api_v1_str}/admin/{admin_user.id}", headers=admin_headers
    )
...
async def test_read_admin_permission_denied(
    client: AsyncClient,
    db: AsyncSession,
    readonly_admin_headers: dict,
    test_settings: Settings,
    ...
    response = await client.get(
        f"{test_settings.api_v1_str}/admin/{target_admin_id}",
        headers=readonly_admin_headers,
    )  # Use test_settings
...
async def test_read_admins(
    ...
    response = await client.get(
        f"{test_settings.api_v1_str}/admin/", headers=super_admin_headers
    )
...
async def test_update_admin_permission_denied(
    client: AsyncClient,
    db: AsyncSession,
    readonly_admin_headers: dict,
    admin_user,
...
async def test_delete_admin(
    ...
    response = await client.delete(
        f"{test_settings.api_v1_str}/admin/{temp_admin.id}", headers=super_admin_headers
    )
...
async def test_delete_admin_permission_denied(
    client: AsyncClient,
    db: AsyncSession,
    content_admin_headers: dict,
    readonly_admin,
    test_settings: Settings,
) -> None:
