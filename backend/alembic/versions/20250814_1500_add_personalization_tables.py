...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "secondary_segments", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("segment_confidence", sa.Float(), nullable=False),
        sa.Column(
            "usage_patterns", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "feature_usage", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "navigation_patterns", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "device_preferences", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.Column(
            "next_likely_actions", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(),
    ...
    op.create_index(
        "idx_personalization_profile_segment",
        "personalization_profiles",
        ["primary_segment"],
    )
    op.create_index(
        "idx_personalization_profile_confidence",
        "personalization_profiles",
        ["segment_confidence"],
    )
    op.create_index(
        "idx_personalization_profile_updated",
        "personalization_profiles",
        ["updated_at"],
    )
    op.create_index(
        "idx_personalization_profile_churn",
        "personalization_profiles",
        ["predicted_churn_risk"],
    )
    op.create_index(
        "idx_personalization_profile_value",
        "personalization_profiles",
    ...
    op.create_table(
        ...
        sa.Column(
            "target_segments", postgresql.JSON(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "target_contexts", postgresql.JSON(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_index(
        "idx_personalization_rule_rule_id",
        "personalization_rules",
        ["rule_id"],
        unique=True,
    )
    ...
    op.create_index(
        "idx_personalization_rule_type_active",
        "personalization_rules",
        ["personalization_type", "is_active"],
    )
    op.create_index(
        "idx_personalization_rule_priority_active",
        "personalization_rules",
        ["priority", "is_active"],
    )
    op.create_index(
        "idx_personalization_rule_ab_test",
        "personalization_rules",
        ["is_ab_test", "ab_test_id"],
    )
    op.create_index(
        "idx_personalization_rule_performance",
        "personalization_rules",
        ["success_rate", "applications_count"],
    )
    op.create_index(
        "idx_personalization_rule_timing",
        "personalization_rules",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["rule_id"], ["personalization_rules.rule_id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        "idx_personalization_interaction_interaction_id",
        "personalization_interactions",
        ["interaction_id"],
        unique=True,
    )
    op.create_index(
        "idx_personalization_interaction_user_rule",
        "personalization_interactions",
        ["user_id", "rule_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "idx_personalization_interaction_outcome",
        "personalization_interactions",
        ["outcome"],
    )
    op.create_index(
        "idx_personalization_interaction_session",
        "personalization_interactions",
        ["session_id"],
    )
    op.create_index(
        "idx_personalization_interaction_created",
        "personalization_interactions",
        ["created_at"],
    )
    op.create_index(
        ...
        "personalization_interactions",
        ["response_time_ms", "engagement_score"],
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["personalization_profiles.user_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["rule_id"], ["personalization_rules.rule_id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "idx_user_personalization_rules_user", "user_personalization_rules", ["user_id"]
    )
    op.create_index(
        "idx_user_personalization_rules_rule", "user_personalization_rules", ["rule_id"]
    )
    op.create_index(
        "idx_user_personalization_rules_active",
        "user_personalization_rules",
        ["is_active"],
    )
    op.create_index(
        "idx_user_personalization_rules_assigned",
        "user_personalization_rules",
        ["assigned_at"],
    )
    ...
    op.create_index(
        ...
        "personalization_segment_analysis",
        ["segment", "analysis_period"],
    )
    op.create_index(
        "idx_personalization_segment_analysis_period",
        "personalization_segment_analysis",
    ...
    op.create_index(
        "idx_personalization_segment_analysis_computed",
        "personalization_segment_analysis",
        ["computed_at"],
    )
    op.create_index(
