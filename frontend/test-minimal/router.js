...
class Router {
  ...
  initialize() {
    ...
    console.log("Router manual initialization starting...");

    // Find router outlet
    this._mainContent = document.querySelector("#router-outlet");

    if (!this._mainContent) {
      console.error("Router outlet not found during manual initialization!");
      return;
    }
   ...
   _initialize() {
     ...
     // Find router outlet - try multiple times in case component isn't ready yet
     this._mainContent = document.querySelector("#router-outlet");

     if (!this._mainContent) {
       console.log("Router outlet not found immediately, waiting...");
       // Try again after a short delay
       setTimeout(() => {
         this._mainContent = document.querySelector("#router-outlet");
         if (!this._mainContent) {
           console.error("Router outlet still not found after delay!");
           return;
         }
         console.log("Router initialized after delay, outlet found:", this._mainContent);
